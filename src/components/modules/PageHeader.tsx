      ...
      font-bold"
        ...
        <div className="breadcrumbs bg-new-products p-4 flex justify-center items-center gap-x-4 cursor-pointer ">
          <div className="breadcrumb flex items-center justify-center gap-x-2 text-text hover:text-title transition-all">
            <Link href={'/'} className="text-[12px] uppercase text-text
            hover:text-title transition-all font-bold tracking-widest">home</Link>
            <FaArrowRight className="text-text text-[10px] "/>
          </div>
          <div className="breadcrumb flex items-center justify-center gap-x-2 text-text hover:text-title transition-all">
            <Link href={`/${title}`} className="text-[12px] uppercase text-title
            hover:text-title transition-all font-bold tracking-widest">{title}</Link>
